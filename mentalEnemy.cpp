...
void mentalEnemy::initialization(SDL_Renderer *ren, int x, int y) {
    lives = 50;
...
void mentalEnemy::update(SDL_Renderer *ren, Player &player, Uint8 *map[], const unsigned tileSide, const unsigned short frameDelay, SDL_DisplayMode displayMode) {
...
bool mentalEnemy::collisionWithMap(collisionCode code, Uint8 *map[], const unsigned tileSide, Player &player) {
    int i, j;
    switch (code) {
    case t:
...
void mentalEnemy::collisionWithPlayer(Player &player, SDL_DisplayMode displayMode, const unsigned short frameDelay) {
...
void mentalEnemy::collisionWithPlayerAttacks(Player &player, Arrow *arrow) {
...
void mentalEnemy::collisionWithPlayerAttacks(Player &player, Bomb *bomb) {
...
void mentalEnemy::collisionWithPlayerAttacks(Player &player, Boomerang *boomerang) {
...
void mentalEnemy::updateAnim(animationCode code) {
...
mentalEnemy& mentalEnemy::operator=(const mentalEnemy &obj) {
    if (this != &obj) {
        k = obj.k;
        m = obj.m;
        dstRect = obj.dstRect;
